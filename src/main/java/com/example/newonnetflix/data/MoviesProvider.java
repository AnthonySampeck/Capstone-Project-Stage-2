...
public class MoviesProvider extends ContentProvider {
	...
	public String getType(Uri uri) {
		...
		switch (match) {
			case ITEMS:
				return MoviesContract.Items.CONTENT_TYPE;
			case ITEMS__ID:
				return MoviesContract.Items.CONTENT_ITEM_TYPE;
			default:
	...
	public Uri insert(Uri uri, ContentValues values) {
		...
		switch (match) {
			case ITEMS: {
				...
				return MoviesContract.Items.buildItemUri(_id);
			}
			default: {
				throw new UnsupportedOperationException("Unknown uri: " + uri);
			}
	...
	private SelectionBuilder buildSelection(Uri uri, int match, SelectionBuilder builder) {
		...
		switch (match) {
			...
			case ITEMS__ID: {
				...
				return builder.table(Tables.ITEMS).where(MoviesContract.Items._ID + "=?", _id);
			}
			default: {
				throw new UnsupportedOperationException("Unknown uri: " + uri);
			}
